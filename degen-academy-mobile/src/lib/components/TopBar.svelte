...
<div class="bg-slate-900/70 backdrop-blur-xl border-y border-white/10 py-6 px-8">
  ...
  <div class="flex items-center justify-center gap-4 mb-6">
    ...
    <!-- Goal -->
    <div class="px-5 py-3 bg-white/5 border border-white/10 rounded-lg text-center">
